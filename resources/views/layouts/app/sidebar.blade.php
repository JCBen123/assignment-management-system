<aside id="sidebar" class="w-64 bg-gray-400 text-gray-900 border-r border-gray-800 h-[calc(100vh-4rem)] p-4
    flex flex-col transition-[width] duration-300 ease-in-out overflow-hidden relative z-50
    ...
    <ul class="space-y-3">
        ...
        <li>
            <a href="/subjects" class="flex items-center gap-3 px-5 py-4 rounded
                hover:bg-gray-200 dark:hover:bg-gray-700 relative">
